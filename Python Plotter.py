...
class MainWindow (QWidget):
    ...
    def __init__(self):
        ...
        ReqMsg.setStyleSheet("border : 1px solid black; background-color: black; color : white")
        ...
        # set some other preferences in the style like:
        # the boarder, the background, the line color
        self.errormsg.setStyleSheet("border: 1px solid black; background-color: black; color: white")
